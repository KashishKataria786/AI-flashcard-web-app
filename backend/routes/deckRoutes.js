...
import { getAllDecks, getDeckById, searchDecks, regenerateDeck, deleteDeck, exportDeckToPDF } from '../controllers/deckController.js';
import authMiddleware from '../middleware/authMiddleware.js';

const router = express.Router();

router.get('/', authMiddleware, getAllDecks);
router.get('/search', authMiddleware, searchDecks);
